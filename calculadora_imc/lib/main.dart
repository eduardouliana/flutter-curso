...
class _HomeState extends State<Home> {
  ...
  void _calculate() {
    setState(() {
      ...
      double minHeight = ((height * height) * 18.6);
      double maxHeight = ((height * height) * 24.9);

      if (imc < 18.6) {
        _infoText = "Abaixo do Peso (IMC= ${imc.toStringAsPrecision(3)}). "
            "Seu peso deveria estar entre: ${minHeight.toStringAsPrecision(3)} e ${maxHeight.toStringAsPrecision(3)}";
      } else if ((imc >= 18.6) && (imc < 24.9)) {
        _infoText = "Peso Ideal (IMC= ${imc.toStringAsPrecision(3)}). "
            "Pode variar de: ${minHeight.toStringAsPrecision(3)} até ${maxHeight.toStringAsPrecision(3)}";
